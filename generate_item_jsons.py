...
ITEM_STATS = {
    ...
    # レイピア（特徴：耐久高め、ダメージ低め、mining_speed=1でOK）
    "wooden_rapier":     {"durability": 85,   "damage": 2, "efficiency": 2,  "mining_speed": 1},
    "stone_rapier":      {"durability": 160,  "damage": 3, "efficiency": 4,  "mining_speed": 1},
    "iron_rapier":       {"durability": 300,  "damage": 4, "efficiency": 6,  "mining_speed": 1},
    "golden_rapier":     {"durability": 42,   "damage": 2, "efficiency": 12, "mining_speed": 1},
    "karmesine_rapier":  {"durability": 1600, "damage": 5, "efficiency": 6,  "mining_speed": 1},
    "diamond_rapier":    {"durability": 2100, "damage": 4, "efficiency": 8,  "mining_speed": 1},
    "netherrite_rapier": {"durability": 2600, "damage": 5, "efficiency": 9,  "mining_speed": 1},
    "bone_rapier":       {"durability": 130,  "damage": 3, "efficiency": 3,  "mining_speed": 1},
}
...
STICK_MULTIPLIERS = {
    ...
    "karmesine_stick":  {"durability": 0.9, "damage": 2.7, "efficiency": 1.9},
...
# pickaxe, sword, rapier で終わるファイルを全てfrontsに
fronts = [
